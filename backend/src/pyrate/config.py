...
class ElasticsearchConfig(BaseSettings):
    ...
    index_prefix: str = Field(default="pyrate")
...
class EmailConfig:
    ...
    from_email: str = "noreply@pyrate.media"
    from_name: str = "Pyrate Media"
...
class ConnectionSettings(BaseSettings):
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://pyrate:pyrate@localhost:5432/pyrate",
    ...
    # Enable hosted web app at app.pyrate.media (adds CORS origin)
...
async def load_settings_from_database():
    ...
    async with sessionmanager.session() as session:
        ...
        if not effective:
            ...
            _logger = _logging.getLogger("pyrate.config")
