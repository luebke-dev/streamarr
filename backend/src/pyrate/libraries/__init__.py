...
def _import_libraries() -> dict[str, type[LibraryBase]]:
    ...
    from pyrate.libraries.movies import MovieLibraryPlugin
    from pyrate.libraries.shows import ShowLibraryPlugin
    from pyrate.libraries.music import MusicLibraryPlugin
    from pyrate.libraries.games import GameLibraryPlugin
    from pyrate.libraries.books import BookLibraryPlugin
