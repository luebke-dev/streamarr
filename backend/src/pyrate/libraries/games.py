...
class GameLibraryPlugin(LibraryBase):
    ...
    async def score_release(
        ...
        pyrate can actually run in the retro container — is preferred over an
        ...
        if is_retro_platform(rel_platform):
            score += 30  # native ROM we can boot in pyrate-retro
    ...
    async def handle_completed_download(
        ...
        *,
        ...
        from pyrate.models.media import AvailabilityStatus, MediaFile
