"""Library-filter builder: build collections from pyrate's local catalogue.
...
from pyrate.metadata.list_sources import ExternalRef, ListSourceMediaType
...
class LibraryFilterBuilder(SmartCollectionBuilder):
    """Build refs from MediaItem rows already in pyrate.
