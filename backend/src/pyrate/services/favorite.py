...
from pyrate.schemas.favorite import (
    FavoriteListItem,
    ...
    async def toggle(
        ...
        if is_now_favorited:
            ...
            if perms is not None and perms.favorites_permanent:
                try:
                    from pyrate.worker import promote_favorite_to_library
                ...
                try:
                    from pyrate.worker import backfill_favorite_monitored
            ...
            try:
                from pyrate.worker import unmonitor_favorite
