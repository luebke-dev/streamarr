...
from pyrate.metadata.tmdb import TMDB as TmdbClient
...
from pyrate.models.person import MediaCast
...
# Map pyrate MediaType → (tmdb_segment, list_item_type)
MEDIA_TYPE_MAP = {
...
class RecommendationService:
    ...
    async def _get_tmdb(self) -> TmdbClient:
        if self._tmdb is None:
            from pyrate.services import get_tmdb_api_key
    ...
    async def build_user_profile(
        ...
        from pyrate.models.list import ListType as LT
