...
RENDER_CACHE_PREFIX = "pyrate:page-layout:rendered:"
RENDER_STALE_PREFIX = "pyrate:page-layout:rendered-stale:"
...
def artwork_cache_enabled() -> bool:
    return env_flag("PYRATE_ARTWORK_CACHE_ENABLED", False)
