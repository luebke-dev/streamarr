...
# ``pyrate.services.playback_decision`` and the transcode/probe *lifecycle*
# helpers in ``pyrate.services.transcode_lifecycle``. They are re-exported here
# so existing importers of ``pyrate.services.play`` keep working unchanged.
# ---------------------------------------------------------------------------
from pyrate.services.playback_decision import (  # noqa: F401  (re-export)
...
from pyrate.services.transcode_lifecycle import (  # noqa: F401  (re-export)
