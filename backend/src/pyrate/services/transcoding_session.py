...
REDIS_KEY_PREFIX = "pyrate:transcoding:session:"
REDIS_SESSIONS_SET = "pyrate:transcoding:sessions"
...
class TranscodingSessionService:
    ...
    def _get_quarantine_key(self, content_id: str) -> str:
        ...
        return f"pyrate:transcoding:quarantine:{content_id}"
    ...
    async def get_session_logs(
        ...
        if session.runtime_type == "kubernetes" and session.job_name:
            try:
                from pyrate.services.kubernetes import get_kubernetes_transcoding_service
