...
from pyrate.models.media import MediaFile, MediaType
from pyrate.schemas.play_token import PlayTokenCreate, PlayTokenRead
...
from pyrate.services.playback_decision import (
...
from pyrate.services.rate_limiter import _get_redis, check_and_record
...
async def _acquire_transcode_lock(user_guid: str, media_id: str) -> bool:
    lock_key = f"pyrate:transcode_lock:{user_guid}:{media_id}"
    try:
