...
from streamarr.api.dependencies import CurrentSuperuser, CurrentUser, DatabaseSession
...
from streamarr.schemas.invite import InviteListResponse
from streamarr.schemas.media import MediaItemRead
from streamarr.schemas.user import (
    UserCodecSettings,
    UserCreate,
...
async def get_user_friendships(
    ...
    from streamarr.api.v1.friends import FriendshipRead
