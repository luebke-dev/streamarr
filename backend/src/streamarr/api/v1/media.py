...
from streamarr import worker as worker_tasks
...
from streamarr.api.v1.media_filters import MediaListQuery, media_type_for_library
from streamarr.auth.dependencies import get_current_superuser
from streamarr.libraries import get_library_type_for_media_item_type
...
from streamarr.schemas.media import (
    AlbumWithTracks,
...
from streamarr.services import availability as availability_service
from streamarr.services.activity_log import ActivityLogService
from streamarr.services.artwork import (
...
from streamarr.services.cache_control import clear_rendered_layout_cache
...
from streamarr.services.media_detail import MediaDetailService
from streamarr.services.media_serializer import (
...
from streamarr.services.media_streams import MediaStreamOptionsService
from streamarr.services.metadata import MetadataService
from streamarr.services.observability import record_artwork_cache_event
...
from streamarr.services.show_resume import ShowResumeError, ShowResumeService
from streamarr.services.translation import TranslationService
from streamarr.utils.net import UnsafeUrlError, safe_get

# Pure remote-image / trailer normalizers extracted from this router (kept as a
# re-import so existing `from streamarr.api.v1.media import _trailer_candidates`
# call sites keep working).
from streamarr.api.v1._media_artwork import (
...
from streamarr.api.v1._media_normalizers import (
    _find_remote_image,
...
async def proxy_media_image(
    ...
    """Fetch and return the selected remote poster/backdrop through streamarr."""
    service = LibraryService(db)
    media_item = await service.get_media_item(item_guid)
    if not media_item:
        raise HTTPException(status_code=404, detail="Media item not found")
