...
from streamarr.services.container_profiles import (
    available_platforms,
    compute_app_id,
...
from streamarr.services.steam_library import read_steam_library
from streamarr.services.viewing_history import ViewingHistoryService
