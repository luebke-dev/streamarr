...
from streamarr.api.v1.search import search_local_content
from streamarr.api.v1.suggestions import _summaries
from streamarr.api.v1.trailers import browse_trailers
from streamarr.config import settings
from streamarr.models.list import List, ListVisibility
...
from streamarr.schemas.page_layout import (
    PageLayoutCreate,
    PageLayoutRead,
...
from streamarr.services.favorite import FavoriteService
...
from streamarr.services.media_visibility import visibility_conditions
...
def _render_headers(etag: str, status_value: str) -> dict[str, str]:
    return {
        ...
        "ETag": etag,
        "X-Streamarr-Layout-Cache": status_value,
    }
...
async def _warm_rendered_artwork(urls: list[str]) -> None:
    from streamarr.api.v1.media import warm_artwork_cache_urls
