...
from streamarr.auth.dependencies import get_current_user, get_current_user_optional
from streamarr.config import get_app_url
...
from streamarr.schemas.device import (
...
COLLECTION_TAG = "streamarr:collection"
...
PLAYLIST_TAG = "streamarr:playlist"
...
async def play_playlist_on_device(
    ...
    from streamarr.api.v1.devices import send_device_session_play_queue
