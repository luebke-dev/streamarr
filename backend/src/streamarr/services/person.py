...
from streamarr.schemas.person import MediaCastWithMedia, MediaItemBrief
...
class PersonService:
    ...
    async def import_person_filmography(
        ...
        from streamarr.models.media import MediaExternalId
        ...
        try:
            ...
            from streamarr.worker import import_movie, import_show
