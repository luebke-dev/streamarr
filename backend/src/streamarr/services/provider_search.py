...
module (``streamarr.services.search``): turning raw provider payloads (TMDB,
...
# Kept here (single definition) and re-exported by streamarr.services.search so
...
class ProviderSearchMixin:
    ...
    Mixed into :class:`streamarr.services.search.SearchService`. Client
