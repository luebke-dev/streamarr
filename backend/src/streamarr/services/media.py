...
class MediaService:
    ...
    async def _enqueue_reindex(self, media_item_guid: Any, media_type: Any) -> None:
        ...
        if not self._is_indexed(media_type):
            return
        try:
            from streamarr.workers.search_index_worker import reindex_media_item
    ...
    async def _enqueue_remove(self, media_item_guid: Any, media_type: Any) -> None:
        ...
        mt = getattr(media_type, "value", str(media_type))
        try:
            from streamarr.workers.search_index_worker import (
    ...
    async def get_downloads_for_item(self, item_guid: uuid.UUID) -> list:
        ...
        from streamarr.models.media import MediaReleaseLink
    ...
    async def select_best_release(
        ...
        from streamarr.services.quality_profile import (
        ...
        if use_profile and profile is not None:
            ...
            from streamarr.libraries.quality import parse_quality
