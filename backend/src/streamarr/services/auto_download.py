...
class AutoDownloadService:
    ...
    def _filter_by_platform(
        ...
        """
        from streamarr.services.game_platforms import platform_from_release_title
    ...
    async def _dispatch_download(
        ...
        from streamarr.worker import add_download, add_music_download, add_show_download
