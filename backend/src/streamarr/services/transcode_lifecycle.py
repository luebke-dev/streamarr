...
*decision* layer (:mod:`streamarr.services.playback_decision`) and the play-action
orchestration in :mod:`streamarr.services.play`.

For backwards compatibility the public functions here are re-exported from
:mod:`streamarr.services.play`.
"""
...
def _structure_probe_data(probe_data: dict, file_path: str) -> dict:
    ...
    Delegates to the canonical :func:`streamarr.libraries.base.structure_probe_data`
