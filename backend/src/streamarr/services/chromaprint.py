...
from streamarr.models.media_marker import MarkerSource, MarkerType
from streamarr.schemas.media_marker import MediaMarkerCreate
...
MIN_CONFIDENCE = 0.7
CHROMAPRINT_IMAGE = "registry.gitlab.com/streamarr.media/ffmpeg:latest"
...
class ChromaprintService:
    ...
    async def _extract_fingerprint(
        ...
        from streamarr.services.computing import build_media_volumes
