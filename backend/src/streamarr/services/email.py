...
class EmailService:
    ...
    def _initialize_jinja(self):
        ...
        # Path calculation: backend/src/streamarr/services -> backend/templates/email
        # In Docker, this is /app/src/streamarr/services -> /app/templates/email
        templates_path = (
