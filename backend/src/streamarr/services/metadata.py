...
METADATA_PROVIDERS: dict[str, dict[str, Any]] = {
    ...
    "tmdb": {
        ...
        "icon": "mdi-movie-open",
        "module": "streamarr.metadata.tmdb",
        "class_name": "TMDB",
    ...
    "tvdb": {
        ...
        "module": "streamarr.metadata.tvdb",
        "class_name": "TVDB",
        "media_types": ["shows"],
        "capabilities": {
            "search": True,
    ...
    "igdb": {
        ...
        "module": "streamarr.metadata.igdb",
        "class_name": "IGDB",
        "media_types": ["games"],
        "capabilities": {
            "search": True,
    ...
    "spotify": {
        ...
        "icon": "mdi-spotify",
        "module": "streamarr.metadata.spotify",
        "class_name": "Spotify",
        "media_types": ["music"],
        "capabilities": {
            "search": True,
    ...
    "musicbrainz": {
        ...
        "icon": "mdi-music-box",
        "module": "streamarr.metadata.musicbrainz",
    ...
    "shazam": {
        ...
        "icon": "mdi-waveform",
        "module": "streamarr.metadata.shazam",
