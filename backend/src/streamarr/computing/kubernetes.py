...
from streamarr.utils.host_path import sanitize_bind_host_path as _sanitize_host_path
...
class KubernetesComputingProvider(ComputingBase):
    ...
    async def start_task(
        ...
        **kwargs,
        ...
        job_name = f"streamarr-task-{task_id[:8]}"

        # Build labels
        job_labels = {
            "app": "streamarr",
            "component": "computing",
            "streamarr.task_id": task_id,
        }
        if labels:
    ...
    async def get_task_logs(self, task_id: str, follow: bool = False) -> str:
        ...
        label_selector = f"streamarr.task_id={task_id}"
    ...
    async def list_tasks(
        ...
        label_selector = "app=streamarr,component=computing"
        if labels:
        ...
        try:
            ...
            for job in jobs.items:
                ...
                task_id = job_labels.get("streamarr.task_id")
